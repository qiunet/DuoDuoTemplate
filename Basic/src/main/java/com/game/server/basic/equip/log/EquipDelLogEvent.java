 ...
 * 2020-05-22 15:00
 ***/
public class EquipDelLogEvent extends BasePlayerLogEvent {
	private int equipId;
	private int equipCfgId;
	private OperationType operationType;

	public EquipDelLogEvent(PlayerActor player, int equipId, int equipCfgId, OperationType operationType) {
		super(LogType.EQUIP_DELETE, player);
