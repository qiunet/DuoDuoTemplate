package com.game.template.basic.id.person;

import org.qiunet.data.support.CacheDataListSupport;
import java.util.Map;

import com.game.template.basic.id.person.entity.IdBuilderBo;
import com.game.template.basic.id.person.entity.IdBuilderDo;
